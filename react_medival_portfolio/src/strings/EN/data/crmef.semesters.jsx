const CRMEF_SEMESTERS = {
    ...
    semesters: {
        'semester-1': {
            ...
            modules: {
                'lesson-planning': {
                    name: 'Lesson Planning & Learning Design',
                ...
                'cs-reinforcement-1': {
                    name: 'CS Reinforcement I: Informatics Systems, Databases & Python',
                    professor: 'Prof. Snineh',
                    desc: 'Deepened knowledge of information systems architecture, relational database concepts (SQL), and Python programming fundamentals applied to educational contexts.',
                },
                'cs-reinforcement-2': {
                    name: 'CS Reinforcement II: Computer Architecture & Boolean Logic',
                    professor: 'Prof. Iqdour',
                    desc: 'Strengthened understanding of hardware components, CPU architecture, memory hierarchy, and Boolean algebra including logic gates and circuit design.',
                },
                'ict-education-didactics': {
                    name: 'ICT Integration (TICE) & CS Didactics',
                ...
                'education-sciences': {
                    name: 'Core Educational Sciences & Pedagogical Theories',
                    professor: 'Unknown',
                ...
                'research-methodology': {
                    name: 'Action Research & Educational Methodology',
        ...
        'semester-2': {
            ...
            modules: {
                's2-lesson-planning-advanced': {
                    name: 'Advanced Lesson Planning & Differentiated Instruction',
                    professor: 'Prof. Raja Tamri',
                ...
                's2-classroom-communication': {
                    name: 'Classroom Communication & Professional Posture',
                    professor: 'Prof. Hakima Benzaki',
                ...
                's2-cs-reinforcement-3': {
                    name: 'CS Reinforcement III: Algorithms, Data Structures & Complexity',
                    professor: 'Prof. Snineh',
                    desc: 'Mastered core algorithmic concepts including sorting, searching, recursion, and Big-O complexity analysis, applying them to solve real CS curriculum problems.',
                },
                's2-cs-reinforcement-4': {
                    name: 'CS Reinforcement IV: Networking & Operating Systems',
                    professor: 'Prof. Iqdour',
                    desc: 'Studied computer networking fundamentals (OSI model, TCP/IP, protocols) and operating system concepts including process management, file systems, and security basics.',
                },
                's2-assessment-evaluation': {
                    name: 'Assessment & Evaluation in Education',
                    professor: 'Prof. Soufiane Baribi',
                ...
                's2-inclusive-education': {
                    name: 'Inclusive Education & Special Needs Pedagogy',
                    professor: 'Prof. Nadia Zouaoui',
                ...
                's2-capstone-project': {
                    name: 'Capstone Research Project & Final Practicum',
                    professor: 'Prof. Soufiane Baribi',
