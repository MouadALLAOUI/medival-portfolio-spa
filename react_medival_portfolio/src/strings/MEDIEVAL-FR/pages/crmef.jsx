...
const CRMEF = {
    ...
    msp: {
        ...
        downloadRapport: "Télécharger le Parchemin",
        ...
        presentation: {
            ...
            stageInfo: "Chronique du Stage",
            period: "Période de Quête",
            totalSessions: "Séances Total",
            selfTaught: "Séances Autoguidées",
            infrastructure: "Donjon & Domaine",
            supervisorEval: "Évaluation du Maître",
            remerciementText: "Je tiens tout d'abord à remercier chaleureusement notre superviseure {{people_moubaraa-sanaa}}, qui nous a gentiment encadrés et n'a pas hésité à nous accorder son aide et ses conseils. Mes remerciements s'adressent également à tous les formateurs du centre CRMEF pour leurs efforts et leurs conseils.",
        ...
        table: {
            ...
            academie: "Royaume (Académie)",
            province: "Province",
            codeEtablissement: "Code du Donjon",
            milieu: "Terrain",
            teachers: "Maîtres",
            admin: "Intendants",
            computerRoom: "Scriptorium (Salle info)",
            resourceRoom: "Chambre des Ressources",
            library: "Bibliothèque",
            sports: "Terrain d'Entraînement",
            condition: "État",
            successRate: "Taux de Triomphe",
        ...
        documents: {
            ...
            official: "Parchemins Officiels",
            images: "Enluminures & Images",
        },
    },
    videos: {
        title: "CRMEF Academy",
        ...
        home: {
            ...
            subtitle: "Parcourez l'académie, révisez les leçons et suivez votre progression.",
