const projects = [
  {
    ...
    overview: {
      thumbnail: "/assets/projects/1/thumb.png",
      ...
      imgs: [
        { src: "/assets/projects/1/gui.png", alt: "", isBlur: false },
        { src: "/assets/projects/1/Figure_1.png", alt: "", isBlur: false },
      ],
      features: [
        "First In, First Out (FIFO)",
        "Round Robin (RR)",
  ...
  },
  {
    ...
    overview: {
      thumbnail: "/assets/projects/2/thumb.png",
      ...
      imgs: [
        { src: "/assets/projects/2/img 1.png", alt: "Screenshot – Report Example", isBlur: false },
        { src: "/assets/projects/2/code.png", alt: "Screenshot – Code View", isBlur: false },
        { src: "/assets/projects/2/structure.png", alt: "Screenshot – Folder Structure", isBlur: false },
      ],
      features: [
        "📘 Count total words in a text file",
        "🔤 Count total letters used",
  ...
  },
  {
    ...
    overview: {
      thumbnail: "/assets/projects/3/thumb.png",
      ...
      imgs: [
        {
          src: "/assets/projects/3/login.png",
          alt: "Screenshot – login",
          isBlur: false
        },
        {
          src: "/assets/projects/3/addTask.png",
          alt: "Screenshot – Add Task",
          isBlur: false
        },
        {
          src: "/assets/projects/3/editTask.png",
          alt: "Screenshot – Edit Task",
          isBlur: false
        },
        {
          src: "/assets/projects/3/pdfGeneration.png",
          alt: "Screenshot – PDF Generation",
          isBlur: false
        },
        {
          src: "/assets/projects/3/setting.png",
          alt: "Screenshot – Settings",
          isBlur: false
        },
        {
          src: "/assets/projects/3/about.png",
  ...
  },
  {
    ...
    overview: {
      thumbnail: "/assets/projects/9/thumb.png",
      ...
      imgs: [
        { src: "/assets/projects/9/1.png", alt: "", isBlur: false },
        { src: "/assets/projects/9/2.png", alt: "", isBlur: false },
        { src: "/assets/projects/9/3.png", alt: "", isBlur: false },
        { src: "/assets/projects/9/4.png", alt: "", isBlur: false },
        { src: "/assets/projects/9/5.png", alt: "", isBlur: false },
        { src: "/assets/projects/9/6.png", alt: "", isBlur: false },
      ],
      features: [
        "CRUD operations",
        "Database migration",
